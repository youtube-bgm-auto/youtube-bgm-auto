...
TITLE_TEMPLATES = {
    ...
    "brown":      "Brown Noise {d} 🌿 | Like Rainfall on a Quiet Afternoon | ADHD Focus & Deep Sleep",
    "rain_light": "Gentle Rain on the Window {d} 🌧 | A Slow Sunday Morning Indoors | Sleep & Study",
    "rain_heavy": "Heavy Rain at Night {d} ⛈ | Stranded Inside While the Storm Rolls In | Deep Sleep",
    "thunderstorm":"Thunder & Rain {d} 🌩 | A Wild Night When the Power Almost Went Out | Sleep Sounds",
    "rain_roof":  "Rain on City Rooftops {d} 🏠 | A Quiet Sunday Morning in the Rain | Sleep & Focus",
    "ocean":      "Ocean Waves {d} 🌊 | Falling Asleep to the Sound of an Empty Beach | Deep Sleep",
    "beach":      "Tropical Beach Sounds {d} 🏖 | The Last Hour Before Everyone Wakes Up | Sleep & Relax",
    "river":      "Mountain River {d} 🏞 | Walking Alone on a Trail No One Else Knows | Sleep & Focus",
    "waterfall":  "Waterfall in the Forest {d} 💧 | Hidden Deep Where the Map Ends | Deep Sleep",
    "forest":     "Forest at Night {d} 🌲 | The Quiet That Settles After the Last Bird Stops | Sleep",
    "city":       "City Ambiance {d} 🌃 | Working Late When the Streets Finally Empty Out | Focus",
    "paris":      "Paris Street Café {d} ☕🗼 | A Rainy Tuesday Afternoon on the Left Bank | Study",
    "cafe":       "Coffee Shop Ambiance {d} ☕ | The Corner Seat Nobody Else Takes | Study & Work",
    "library":    "Quiet Library {d} 📚 | Deep in the Stacks on a Winter Afternoon | Study & Focus",
    "fan":        "Electric Fan White Noise {d} 🌀 | Summer Nights with the Window Open | Sleep",
    "airplane":   "Airplane Cabin {d} ✈️ | Somewhere Over the Ocean at 3am | Sleep Sounds",
    "train":      "Train Journey {d} 🚂 | Watching the Countryside Pass Without Anywhere to Be | Sleep",
    "fireplace":  "Crackling Fireplace {d} 🔥 | Nowhere to Be on a Cold Winter Night | Sleep & Relax",
    # ── ファンタジー・世界観系 ──
    "fantasy_library": "Ancient Magic Library 📚🕯️ | {d} | Lost Among Spells & Forgotten Scrolls | Dark Fantasy Music",
    "medieval_tavern": "Medieval Tavern Ambiance 🍺🔥 | {d} | The Night Before a Long Journey | Dark Fantasy Music",
    "enchanted_forest":"Enchanted Forest 🌿✨ | {d} | Where the Trees Remember Every Footstep | Dark Fantasy Music",
    "ancient_temple":  "Ancient Temple 🏛️🌙 | {d} | Lost in a Forgotten Civilization | Dark Fantasy Music",
    "cozy_cottage":    "Cozy Cottage 🏡📖 | {d} | A Night at the Edge of the Enchanted Wood | Fantasy Music",
    "castle_wind":     "Castle Ramparts 🏰🌬️ | {d} | Standing Watch While the Kingdom Sleeps | Dark Fantasy Music",
    "space_station":   "Deep Space Station 🚀🌌 | {d} | Alone on the Outer Rim at the End of a Long Shift | Sci-Fi Music",
    "dragon_cave":     "Dragon's Cave 🐉🔥 | {d} | Deep Beneath the Mountain Where No Light Reaches | Dark Fantasy Music",
    # ── 実録音源 ──
    "train_underpass": "Train Underpass {d} 🚃 | The Walk Home Under the Tracks at Midnight | Sleep & Focus",
    "study_hall":      "Study Hall Ambiance {d} 📚 | The Hour Before the Exam When Everything Gets Quiet | Focus",
    "waiting_room":    "Station Waiting Room {d} 🚉 | An Hour Between Trains With Nowhere to Rush | Study & Focus",
    "night_drive":     "Night Drive {d} 🚗 | Music Off, Windows Down, No Particular Destination | Sleep & Focus",
    "electric_fan_real": "Electric Fan {d} 🌀 | Hot Summer Nights When Sleep Finally Comes | Deep Sleep",
}
